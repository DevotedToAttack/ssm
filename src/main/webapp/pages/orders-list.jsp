			...
			<section class="content">
						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="删除" id="del">
											<i class="fa fa-trash-o"></i> 删除
										</button>
										<button type="button" class="btn btn-default" title="搜索"
												onclick="location.href='${pageContext.request.contextPath}/orders/findString.do?page=0&pageSize=${pageInfo.pageSize}&findString='+getSeek()">
											<i class="fa fa-send"></i> 搜索
										</button>
							...
							<div class="box-tools pull-right">
								<div class="has-feedback">
									<input type="text" class="form-control input-sm" id="seek"
										   placeholder="搜索">
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li>
                                <a href="${pageContext.request.contextPath}/orders/findAll.do?page=0&pageSize=${pageInfo.pageSize}" aria-label="Previous">首页</a>
                            </li>
	...
	<script>
		...
		$('#del').click(function() {
			$("[name='ids']").each(function() {
				if ($(this).is(':checked')) {
					location.href = "${pageContext.request.contextPath}/orders/delete.do?id="
