			...
			<form action="${pageContext.request.contextPath}/user/alter.do"
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 title">用户ID</div>
						<div class="col-md-8 data">
							<input type="text" class="form-control" name="id" readonly="true"
								placeholder="用户ID" value="${userInfo.id}">
						</div>
						...
						<div class="col-md-4 data">
							<select class="form-control select2" style="width: 100%"
								name="status">
								<option value="0" selected="${userInfo.status eq '0'?'selected':''}">关闭</option>
								<option value="1" selected="${userInfo.status eq '1'?'selected':''}">开启</option>
							</select>
						</div>
