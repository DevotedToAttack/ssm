...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/orders/alter.do" method="post">
			<div class="panel panel-default">
				...
				<div class="row data-type">
					...
					<div class="col-md-4 data">
						<div class="input-group date">
							...
							<input type="text" class="form-control pull-right"
								   id="datepicker-a3" name="orderTimeStr"
								   value="${orders.orderTimeStr}">
						</div>
					</div>

					<div class="col-md-2 title">参与人数</div>
					<div class="col-md-4 data">
						<input type="text" name="peopleCount" class="form-control" placeholder="参与人数"
							value="${orders.peopleCount }">
					</div>
					...
					<div class="col-md-4 data text">订单状态-${orders.orderStatusStr}</div>
			...
			<div class="box-tools text-center">
				...
				<button type="submit" class="btn bg-default">保存修改</button>
