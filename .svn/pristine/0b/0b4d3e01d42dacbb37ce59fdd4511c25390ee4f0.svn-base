			...
			<div class="box box-primary">
					...
					<div class="table-box">
						...
						<div class="pull-left">
							<div class="form-group form-inline">
								<div class="btn-group">
                                    <button type="button" class="btn btn-default" title="删除" onclick="">
                                        <i class="fa fa-trash-o"></i> 删除
                                    </button>
									<button type="button" class="btn btn-default" title="搜索"
                                            onclick="location.href='${pageContext.request.contextPath}/sysLog/findString.do?page=0&pageSize=${pageInfo.pageSize}&findString='+getSeek()">
				...
				<div class="box-footer">
					...
					<div class="box-tools pull-right">
						<ul class="pagination">
							<li>
								<a href="${pageContext.request.contextPath}/sysLog/findAll.do?page=0&pageSize=${pageInfo.pageSize}" aria-label="Previous">首页</a>
							</li>
