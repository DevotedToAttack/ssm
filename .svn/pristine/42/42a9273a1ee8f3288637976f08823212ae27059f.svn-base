				...
				<div class="box box-primary">
								...
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="搜索"
												onclick="location.href='${pageContext.request.contextPath}/role/findString.do?page=0&pageSize=${pageInfo.pageSize}&findString='+getSeek()">
									...
									<c:forEach items="${pageInfo.list}" var="role">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/role/findRoleByIdAndAllRole.do?id=${role.id}" class="btn bg-olive btn-xs">添加权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li>
									<a href="${pageContext.request.contextPath}/role/findAll.do?page=0&pageSize=${pageInfo.pageSize}" aria-label="Previous">首页</a>
								</li>
